...
namespace SB.PayrollManagement.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class HourlyEmployeesController : ControllerBase
    {
        private readonly IHourlyEmployeeService _service;

        public HourlyEmployeesController(IHourlyEmployeeService service)
        {
            _service = service;
        }
        ...
        public async Task<IActionResult> Create([FromBody] CreateHourlyEmployeeDto dto)
        {
        ...
        [Authorize(Roles = "Administrador")]
        public async Task<IActionResult> Update(int employeeId, [FromBody] UpdateHourlyEmployeeDto dto)
        {
